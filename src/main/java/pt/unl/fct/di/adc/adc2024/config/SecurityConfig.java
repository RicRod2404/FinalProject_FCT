...
public class SecurityConfig {
    ...
    public static final RequestMatcher[] ALLOWED = new RequestMatcher[] {
            ...
            new AntPathRequestMatcher("/rest/users/forgot-password", HttpMethod.PUT.name()),
            new AntPathRequestMatcher("/rest/products", HttpMethod.GET.name()),
            new AntPathRequestMatcher("/rest/products/category", HttpMethod.GET.name()),
            new AntPathRequestMatcher("/rest/rankings/**", HttpMethod.GET.name()),
