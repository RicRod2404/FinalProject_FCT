...
import pt.unl.fct.di.adc.adc2024.dtos.forms.community.PromoteMemberForm;
...
public class PromoteMemberValidator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return clazz == PromoteMemberForm.class;
    }

    @Override
    public void validate(Object target, Errors errors) {
        var form = (PromoteMemberForm) target;
        ...
        if (user.getId().equals(community.getLeaderId()))
